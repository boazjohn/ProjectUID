...
<a href="member-market.php" class="bigtext">Back</a><br><br>
<h2>Share Market Logs</h2><hr><br><br>

<?php 
$result = mysql_query("select * from udetails_shlog order by id") or die();
