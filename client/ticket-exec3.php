...
$data=$id;$data.=' Ticket Booked - Rs.';$data.=$amt;$data.='/- Details: ';$data.=$from;$data.=' to ';$data.=$dest;$data.=' (';$data.=$tno;$data.=') ';$data.=' Dated: ';$data.=$date;$data.=' Time: ';$data.=$timed;$data.=' from Credit Card, ';$data.=$acnt;	
