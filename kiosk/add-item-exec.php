...
<div class="tspacemid">
<h2>New Item Added</h2><hr><br><br>
<?php 
if(empty($pid)||empty($url)||empty($name)||empty($type)||empty($stock)||empty($rate))
{ echo 'Fatal Error! Empty queries <img src="images/error.png"></img>'; }
else {
