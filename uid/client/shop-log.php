...
<title>Shopping Usage Logs | UID</title>
...
<a href="member-shop.php" class="bigtext">Back</a><br><br>
<h2>Shopping Logs</h2><hr><br><br>

<?php 
$result = mysql_query("select * from udetails_slog order by id");
